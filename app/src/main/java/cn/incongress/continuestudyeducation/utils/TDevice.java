...
//    }
    ...
    public static void copyTextToBoard(String string) {
        ...
        clip.setText(string);
        ToastUtils.showShorToast(BaseApplication.context().getResources().getString(R.string.copy_success));
    }
    ...
    public static int getNetworkType() {
        ...
        if (nType == ConnectivityManager.TYPE_MOBILE) {
            ...
            if (!cn.incongress.continuestudyeducation.uis.StringUtils.isEmpty(extraInfo)) {
